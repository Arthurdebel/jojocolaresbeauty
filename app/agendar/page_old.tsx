            ...
            if (docSnap.exists()) {
                ...
                if (settings.workingHours) {
                    setWorkingHours({
                        ...
                        end: settings.workingHours.end || '20:00'
                    });
                }
            }
        });
            ...
            try {
                ...
                useEffect(() => {
                    ...
                    const checkFullyBookedDates = async () => {
                        ...
                        for (let d = new Date(today); isBefore(d, endDate); d = addDays(d, 1)) {
                                                ...
                                                <DatePicker
                                                    ...
                                                    dayClassName={(date) =>
                                                        isDateFullyBooked(date)
                                                            ? 'react-datepicker__day--disabled text-muted-foreground line-through'
                                                            : ''
                                                    }
                                                    inline
                                                    locale={ptBR}
